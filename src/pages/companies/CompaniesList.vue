    ...
    <section>
      <base-card>
        ...
        <ul v-else-if="hasCompanies">
          <company-item v-for="company in filteredCompanies" :key="company.ID" :ID="company.ID" :Name="company.Name"
            :Address="company.Address" :City="company.City" :Country="company.Country" :Email="company.Email"
            :StartTime="company.StartTime" :EndTime="company.EndTime"></company-item>
        </ul>
